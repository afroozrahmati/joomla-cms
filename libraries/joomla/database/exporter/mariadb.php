...
/**
 * MariaDB export driver.
 *
 * @since       3.0.0
 * @deprecated  4.0  Use PDO MariaDB instead
 *
 * @property-read  JDatabaseDriverMariaDb  $db  The database connector to use for exporting structure and/or data.
 */
class JDatabaseExporterMariadb extends JDatabaseExporter
{
	/**
	...
	protected function buildXml()
	{
		...
		$buffer[] = '<mariadbdump xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">';
	 ...
	 *
	 * @return  JDatabaseExporterMariadb  Method supports chaining.
	 *
	 * @since   3.0.0
	...
	public function check()
	{
		...
		if (!($this->db instanceof JDatabaseDriverMariaDb))
		{
